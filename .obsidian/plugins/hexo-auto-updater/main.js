...
var HexoIntegrationSettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    const hexoFolderSetting = new import_obsidian.Setting(containerEl).setName("Hexo Source Path").setDesc("Specify the path to the Hexo source folder");
    const hexoFolderInput = hexoFolderSetting.addText(
      (text) => text.setPlaceholder("Enter the absolute source path").setValue(this.plugin.settings.hexoSourcePath).onChange(async (value) => {
